...
def evaluate_train_data(train_data_path):
    ...
    train_dataset = ChickenRabbitDataset(config.data, split='train', seed=0, defined_tensor_train_data=train_data_path)
...
if __name__ == '__main__':
    ...
    for file in pkl_files:
        try:
            write_log(directory, f"evaluating {directory}/{file}")
